---
title: "Using the RStudio IDE with Quarto"
author: "Alyssa Yount"
date: last-modified
date-format: "[Last modified on] August 24, 2023 HH:mm:ss zzz"
format: 
  html: default
  pdf: default
editor: visual
...
-   The answer to 6 + 3 (`r 6+3` or `r ans`)
-   The answer for the expression 6+3 appears in the console section of the bottom left panel in black as well as under the R code chunk. 
...
-   The answer does not appear here as I have not used the variable "ans". 

-   The value of a is shown below under the console tab of the bottom left panel. The value of a is shown as 6 + 3. 

-   After typing a into the code chunk, the answer to the expression 6 + 3 is stated under the code chunk as well as in the console section of the bottom left panel. 
:::
...
-   The "^" operator acts as an operation to put whatever the value before it is to the power of the value placed after the operator. So, in this example, a, or 9, is put to the power of 2, which is 81. 
:::
...
-   The sum function sums all of the values entered and adds them together. So, in this example, the values a, or 9, plus x, or 6, plus y, or 7 is 22. 
:::
...
-   After clicking on the broom icon in the top right corner of the screen, the environment pane was wiped of each of the values and their answers. 
:::
...
-   After selecting "Run All", the console screen changed and the environment pane was refreshed to include all previously used values and their given numbers. 
:::
...
-   The expression v + 2 adds 2 to each of the values gievn to v, which includes 2, 4 and 6. This changed to 4, 6 and 8. 
:::
...
-   The environment pane tells us the characters are not numbers by putting each of the words in quotation marks. 
:::
